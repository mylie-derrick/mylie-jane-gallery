          ...
          {available ? (
            <>
              <Link
                ...
                className="mt-10 inline-flex items-center justify-center bg-primary px-6 py-3 text-sm uppercase tracking-[0.22em] text-primary-foreground transition-colors hover:bg-[color:var(--brand-dusty-blue)]"
              >
                Inquire to Purchase
              </Link>
