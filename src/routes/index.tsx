...
import heroAsset from "@/assets/hero-painting.jpg.asset.json";
...
function Index() {
  ...
  return (
    <>
      <section className="relative h-screen w-full overflow-hidden" style={{ backgroundColor: "var(--brand-olive)" }}>
        <img
          src={heroAsset.url}
          alt="Mylie Jane Derrick painting a still life of oranges and peonies."
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <h1
            className="italic leading-[1.02] text-5xl md:text-7xl lg:text-8xl"
            style={{
          ...
          <p
            className="mt-6 text-xs uppercase md:text-sm"
            style={{
              color: "var(--brand-cream)",
      ...
      <section id="recent-work" className="mx-auto mt-24 max-w-7xl px-6 pt-8 md:mt-32 md:px-10 scroll-mt-16">
        <div className="flex items-end justify-between gap-6 pb-6" style={{ borderBottom: "1px solid var(--brand-mauve)" }}>
          <div>
            <p className="eyebrow">Recent Work</p>
            <h2 className="mt-3 font-serif text-3xl md:text-4xl" style={{ color: "var(--brand-ink)" }}>
        ...
        <div className="mt-12 grid gap-12 md:grid-cols-3">
          {featured.map((p) => (
            ...
            >
              ...
              <div className="mt-4">
                <p className="font-serif text-xl italic" style={{ color: "var(--brand-ink)" }}>{p.title}</p>
      ...
      <section className="mx-auto mt-32 max-w-3xl px-6 text-center md:px-10">
        ...
        <p className="mt-6 font-serif text-2xl italic leading-relaxed md:text-3xl" style={{ color: "var(--brand-ink)" }}>
          "I paint the things that stop me — a bowl of oranges in warm light, a
          Western sky just before it turns."
        </p>
        <p className="mt-6 text-sm uppercase tracking-[0.22em]" style={{ color: "var(--brand-wine)" }}>
          — Mylie Jane
        </p>
      </section>
    </>
